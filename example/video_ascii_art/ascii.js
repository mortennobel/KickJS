...
requirejs(['kick', 'text!fragmentShaderAscii.glsl', 'text!vertexShaderTex.glsl', 'text!fragmentShaderAscii.glsl', 'text!fragmentShaderTex.glsl'],
    function (KICK, fragmentShaderAscii, vertexShaderTex, fragmentShaderTex) {
    "use strict";
