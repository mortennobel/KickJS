...
//      marginBottom: '6px',
    ...
    dom.bind(this.__hue_field, 'mousedown', function(e) {
      setHValues(e);
      dom.bind(window, 'mousemove', setHValues);
    ...
    function fieldDown(e) {
      ...
      dom.bind(window, 'mousemove', setSVValues);
      dom.bind(window, 'mouseup', unbindSV);
    }

    function unbindSV() {
      dom.unbind(window, 'mousemove', setSVValues);
    ...
    function unbindH() {
      dom.unbind(window, 'mousemove', setHValues);
